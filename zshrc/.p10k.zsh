# Generated by Powerlevel10k configuration wizard on 2024-05-29 at 21:39 CEST.
...
() {
  ...
  # Setting this to quit does not cause an error message 
  # when a pokemon is shown
